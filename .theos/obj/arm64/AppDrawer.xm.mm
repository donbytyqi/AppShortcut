...
static void _logos_method$_ungrouped$SpringBoard$applicationDidFinishLaunching$(_LOGOS_SELF_TYPE_NORMAL SpringBoard* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id application) {
			...
			if ([isEnabled isEqual:@0]) {
				...
				double lastPositionKnownY = [[[NSUserDefaults standardUserDefaults] objectForKey:@"lastPositionOfCircleX"] floatValue];
				...
				if(lastPositionKnownX == 0.0 && lastPositionKnownY == 0.0) {
					tempView.center = CGPointMake(15.0, 15.0);
				}
